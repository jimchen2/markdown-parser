  ...
  return (
    <div className="mt-6 py-4 px-6 bg-gray-100 rounded-lg shadow-inner flex justify-between items-center">
      <div className="text-sm text-gray-600 flex items-center space-x-4">
        <span className="font-medium">Words: <span className="text-gray-800">{wordCount}</span></span>
        <span className="font-medium">Characters: <span className="text-gray-800">{charCount}</span></span>
        {isUploading && (
